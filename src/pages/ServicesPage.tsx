      ...
      <section className="px-6 md:px-12 py-20 text-center max-w-5xl mx-auto">
        <motion.div initial="hidden" animate="visible" variants={fadeIn}>
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-full w-fit mb-6">
            ...
            <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest">Our Capabilities</span>
          </div>
        ...
        >
          {servicesData.map((service, i) => (
            <Link 
              ...
              className="p-6 md:p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-blue-500/30 transition-all group relative overflow-hidden flex outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
            >
              <motion.div 
                variants={fadeIn}
              ...
              >
                ...
                <div className="mb-8 inline-flex p-4 rounded-xl bg-[#18191A]/50 border border-white/5 self-start transform transition-all duration-500 group-hover:scale-110 group-hover:-rotate-6 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.2)]">
                  {service.icon}
                </div>
                
                <h3 className="text-xl font-bold mb-3 group-hover:text-blue-500 transition-colors">{service.title}</h3>
                <p className="text-gray-400 text-sm leading-relaxed mb-8 flex-1">{service.shortDesc}</p>
                
                <div className="inline-flex items-center text-[11px] uppercase font-bold text-blue-500 hover:text-blue-400 transition-colors mt-auto group-hover:translate-x-1 duration-300">
